...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while roll <= num_rolls:
        ...
        if out_of_dice == 1:
            ...
            sum_out_of_dice += out_of_dice
        roll += 1
    return sum_out_of_dice
    "*** YOUR CODE HERE ***"
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    ones_digits_current = player_score % 10
    tens_digits_opponent = opponent_score // 10 % 10
    diff = abs(ones_digits_current - tens_digits_opponent)
    if diff == 0:
        return 1
    else:
        return 3 * diff
...
def is_always_roll(strategy, goal=GOAL):
    ...
    """score = 0
    opponent_score = 0
    roll_num = strategy(score, opponent_score)
    while score < goal:
        while opponent_score < goal:
            opponent_score += 1
            roll_num_alert = strategy(score, opponent_score)
            if roll_num != roll_num_alert:
                return False
        opponent_score = 0
        score += 1
    return True
...
def make_averaged(original_function, times_called=1000):
    ...
    "*** YOUR CODE HERE ***"
    def average(*args):
        dice_sum, k = 0, times_called
        while k > 0:
            dice_sum += original_function(*args)
            k -= 1
        return dice_sum / times_called
    return average
    # END PROBLEM 8
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    score_bear = boar_brawl(score,opponent_score)
    if score_bear >= threshold:
        return 0
    else:
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    score_bear = boar_brawl(score,opponent_score)
    score_sus = sus_points(score + score_bear)
