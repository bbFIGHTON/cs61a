...
def count_dollars(total):
    ...
    def constrained_count(total, largest_bill):
        ...
        if largest_bill == None:
            return 0
        without_dollar_count = constrained_count(total, next_smaller_dollar(largest_bill))
        with_dollar_count = constrained_count(total - largest_bill, largest_bill)
        return without_dollar_count + with_dollar_count
